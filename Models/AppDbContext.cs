...
namespace paradise.Models
{
    public partial class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<lesson_contents>()
                .Property(e => e.content_type)
                .IsUnicode(false);

            modelBuilder.Entity<lesson_quizzes>()
                .Property(e => e.quiz_title)
                .IsUnicode(false);

            modelBuilder.Entity<lesson_quizzes>()
                .HasMany(e => e.quiz_attempts)
                .WithRequired(e => e.lesson_quizzes)
            ...
            modelBuilder.Entity<user_profiles>()
